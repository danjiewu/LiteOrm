...
namespace LiteOrm.Common
{
    ...
    public interface IObjectViewDAO<T> : IObjectViewDAO
    {
        ...
        EnumerableResult<TResult> SearchAs<TResult>(Expression<Func<IQueryable<T>, IQueryable<TResult>>> expr, Func<AutoLockDataReader, TResult>? readerFunc = null);
    }
    #endregion
    ...
    public interface IObjectViewDAO : IExprStringBuildContext
    {
        ...
        EnumerableResult<TResult> SearchAs<TResult>(SelectExpr selectExpr, Func<AutoLockDataReader, TResult>? readerFunc = null);
        /// <summary>
        /// 使用带参数的SQL查询
        /// </summary>
