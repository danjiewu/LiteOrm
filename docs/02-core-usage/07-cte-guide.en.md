...
## 4. Validation rules for duplicate CTE aliases
...
So you can safely reuse the same CTE expr multiple times,or use alias across a large expression tree, as long as the definition stays identical.

## 5. CTE serialization rules
...
### 6.2 Supported approach: write full SQL manually
