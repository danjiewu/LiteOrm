...
基于 `LiteOrm.Benchmark` 项目（Linux Ubuntu 24.04 LTS, Intel Xeon Silver 4314 CPU 2.40GHz, .NET 10.0.3）的测试结果：

### 8.1 性能对比概览（BatchCount=100）

| 框架 | 插入性能 (ms) | 更新性能 (ms) | Upsert (ms) | 关联查询 (ms) |
| :--- | :--- | :--- | :--- | :--- |
| **LiteOrm** | **4.16** | **5.55** | 6.02 | 1.45 |
| FreeSql | 5.00 | 6.38 | **5.22** | **1.43** |
| SqlSugar | 4.37 | 6.23 | 10.43 | 2.32 |
| Dapper | 26.15 | 28.37 | 28.58 | 1.45 |
| EF Core | 20.18 | 18.92 | 21.04 | 5.04 |
...
| 框架 | 插入性能 (ms) | 更新性能 (ms) | Upsert (ms) | 关联查询 (ms) |
| :--- | :--- | :--- | :--- | :--- |
| **LiteOrm** | **12.21** | **20.20** | 19.06 | 9.67 |
| FreeSql | 21.09 | 39.87 | **17.51** | 9.21 |
| SqlSugar | 19.30 | 44.90 | 108.56 | 24.25 |
| Dapper | 216.81 | 243.36 | 242.39 | **8.76** |
| EF Core | 150.28 | 133.85 | 137.46 | 14.10 |
...
| 框架 | 插入性能 (ms) | 更新性能 (ms) | Upsert (ms) | 关联查询 (ms) |
| :--- | :--- | :--- | :--- | :--- |
| **LiteOrm** | **54.27** | **94.34** | **80.58** | 43.11 |
| FreeSql | 90.11 | 204.43 | 91.97 | **42.80** |
| SqlSugar | 100.73 | 243.68 | 1,784.72 | 95.99 |
| Dapper | 1,124.73 | 1,209.28 | 1,211.96 | 45.37 |
| EF Core | 663.25 | 574.62 | 571.41 | 54.02 |
