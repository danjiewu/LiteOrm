...
namespace LiteOrm.AotDemo.Services
{
    ...
    /// </summary>
    public class AotUserService(ObjectDAO<AotUser> objectDAO, ObjectViewDAO<AotUserView> objectViewDAO)
        : EntityService<AotUser, AotUserView>(objectDAO, objectViewDAO), IAotUserService
    {
    }
}
