...
# ORM ÐÔÄÜ²âÊÔ»ã×Ü±¨¸æ (Benchmark Summary)

## ºËÐÄ½áÂÛ
- **¸ßÍÌÍÂÐÔÄÜ**£ºÔÚ 1000 ÐÐ¼° 5000 ÐÐµÄÅúÁ¿²Ù×÷£¨Insert/Update/Upsert£©ÖÐ£¬**LiteOrm ÐÔÄÜÈ«ÃæÁìÅÜ**£¬Í¨³£±È SqlSugar/FreeSql ¿ì 1.5x - 2x£¬±È EF Core ¿ì 10x ÒÔÉÏ¡£
- **ÄÚ´æ¿ØÖÆ**£ºLiteOrm µÄÄÚ´æ·ÖÅä£¨Allocated£©ÏÔÖøµÍÓÚÆäËû¹¦ÄÜÍê±¸ÐÍ ORM£¬ÓÈÆäÔÚ´¦Àí 5000 ÐÐÊý¾ÝÊ±£¬ÄÚ´æ¿ªÏú½öÎª EF Core µÄ 1/20¡£
- **²éÑ¯Ð§ÂÊ**£ºÔÚ¸´ÔÓ Join ²éÑ¯³¡¾°ÏÂ£¬LiteOrm ±£³ÖÁËÓë Dapper ½üºõÒ»ÖÂµÄ½Ó½üÔ­ÉúÇý¶¯µÄÐÔÄÜ£¬ÇÒ´ó·ùÓÅÓÚ EF Core¡£

## »ã×ÜÊý¾Ý¶Ô±È (Mean Time)

### BatchCount: 100 (µÍÊý¾ÝÁ¿)

| ²Ù×÷ÀàÐÍ | EFCore | SqlSugar | LiteOrm | Dapper | FreeSql |
| :--- | :--- | :--- | :--- | :--- | :--- |
